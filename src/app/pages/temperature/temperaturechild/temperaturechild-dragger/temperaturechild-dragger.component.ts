...
@Component({
  selector: 'ngx-temperaturechild-dragger',
  templateUrl: './temperaturechild-dragger.component.html',
  styleUrls: ['./temperaturechild-dragger.component.scss'],
})
export class TemperaturechildDraggerComponent implements AfterViewInit, OnChanges {
  ...
  @Input() arcThickness = 25; // CSS pixels
  ...
  private invalidate(): void {
    this.bottomAngleRad = TemperaturechildDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
