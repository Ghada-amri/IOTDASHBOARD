...
@Component({
  selector: 'ngx-homeroom-selector',
  templateUrl: './homeroom-selector.component.html',
  styleUrls: ['./homeroom-selector.component.scss'],
})
export class HomeRoomSelectorComponent {
